...
// Sum function to calculate the sum of variable arguments
int sum(int count, ...) {
    va_list args;
    va_start(args, count);
    int total = 0;
...
// Min function to find the minimum value among variable arguments
int min(int count, ...) {
    va_list args;
    va_start(args, count);
...
// Max function to find the maximum value among variable arguments
int max(int count, ...) {
    va_list args;
    va_start(args, count);
